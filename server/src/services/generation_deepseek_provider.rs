    ...
    match job_type {
        ...
        "storybook_pages" => json!({
            ...
            "pages": [{
                ...
                "body": "string",
                "illustration": {
                    "camera": "string（镜头与构图，必须按页面功能选择远景、全景、中景、中近景、近景或特写）",
